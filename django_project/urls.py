...
#     # path("logout/", auth_views.LogoutView.as_view(), name="logout"),
#     # path('do-logout/', TemplateView.as_view(template_name='users/logout.html'), name='do-logout'),
...
urlpatterns = [
    ...
    path('password-reset-confirm/<uid64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='users/password_reset_confirm.html'), name='password-reset-confirm'),
    path('', include('blog.urls')),
]
